...
void AIHSetListeningBlock(AIHListeningBlock _Nullable listeningBlock);	// your listening block will get executed whenever someone announces a change

void AIHProcessIcon(NSDictionary *_Nonnull iconDictionary, AIHListeningBlock _Nonnull listeningBlock);	// short-circuit the announcement => listening process in cases where you only want to get badged icons rendered (e.g., after getting other apps' badge info via script)
